            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 pb-12 border-b border-white/5">
                    ...
                    <div className="group flex gap-4 items-start p-4 rounded-xl bg-white/[0.02] border border-white/5 transition-all duration-300 hover:bg-white/[0.04] hover:border-blue-500/20">
                        <div className="p-3 rounded-lg bg-blue-600/10 text-blue-400 transition-transform duration-300 group-hover:scale-110">
                    ...
                    <a href="mailto:info@maastrixsolutions.com" className="group flex gap-4 items-start p-4 rounded-xl bg-white/[0.02] border border-white/5 transition-all duration-300 hover:bg-white/[0.04] hover:border-blue-500/20">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-gray-400 break-all transition-colors duration-200 group-hover:text-white">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 py-16">
                    ...
                    <div className="lg:col-span-4 space-y-6">
                        ...
                        {/* Social Links with standard brand SVGs */}
                    ...
                    {/* Quick Links Map (Spans 4/12 across 2 internal columns) */}
                    ...
                    {/* Newsletter & Trust Badges (Spans 4/12) */}
                    <div className="lg:col-span-4 space-y-6">
                        <div>
                            ...
                            <form onSubmit={(e) => e.preventDefault()} className="flex flex-col sm:flex-row gap-2 max-w-sm">
                                <input
                                    ...
                                    required
                                    className="w-full rounded-sm bg-white/5 border border-white/10 px-4 py-2.5 text-xs text-white placeholder-gray-500 focus:outline-none focus:border-blue-500/50 transition-colors"
                                />
                                <button
                                    type="submit"
                                    className="inline-flex items-center justify-center gap-1 px-5 py-2.5 bg-blue-600 hover:bg-blue-700 text-white text-xs font-bold uppercase tracking-wider rounded-sm transition-all duration-200"
                                >
                ...
                <div className="flex flex-col sm:flex-row items-center justify-between gap-6 py-8 border-t border-white/5 text-[11px]">
                    ...
                    <div className="flex flex-wrap gap-x-4 gap-y-2 text-gray-500 justify-center">
                        {["Terms & conditions", "Privacy Policy", "FAQs", "Sitemap", "Blog", "Feedback", "Contact us"].map((item) => (
                            <Link key={item} href={`/${item.toLowerCase().replace(/ & /g, "-").replace(/ /g, "-")}`} className="hover:text-gray-300 transition-colors">
                                {item}
                            </Link>
                        ))}
                    </div>
